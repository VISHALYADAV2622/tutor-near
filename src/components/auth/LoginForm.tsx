  ...
  return (
    <div>
      <div className="mb-7">
        ...
        <p className="text-gray-500 text-sm mt-1">Sign in to continue to TutorNear</p>
      </div>
      ...
      {tab === "password" ? (
        <form onSubmit={handleSubmit(onSubmit)} noValidate className="flex flex-col gap-4">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="mt-1 w-full py-3 bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white text-sm font-semibold rounded-xl
