...
export default function OTPLogin() {
  ...
  const verifyOTP = async () => {
    ...
    console.log("Verify OTP:", { email: sentEmail, otp });
    ...
    return (
      <div className="flex flex-col gap-5">
        <div className="bg-blue-50 border border-blue-100 rounded-xl p-4 flex items-start gap-3">
          ...
          <div>
            <p className="text-sm font-medium text-gray-800">OTP sent to</p>
            <p className="text-sm text-blue-600 font-semibold">{sentEmail}</p>
            <p className="text-xs text-gray-500 mt-0.5">Check your inbox and enter the 6-digit code below.</p>
          </div>
        </div>

        <div className="flex flex-col items-center gap-4">
          <p className="text-sm font-medium text-gray-700 text-center">Enter verification code</p>
        ...
        <div className="flex items-center justify-center gap-2 text-sm">
          {timer > 0 ? (
            <p className="text-gray-500">
              Resend in <span className="font-semibold text-blue-600 tabular-nums">{timer}s</span>
            </p>
          ) : (
            <button
              type="button"
  ...
  return (
    <form onSubmit={handleSubmit(sendOTP)} noValidate className="flex flex-col gap-4">
